...
function displayItems() {
    ...
    var frappuccino = document.getElementById('frappuccino');;
    var coldbrew = document.getElementById('coldbrew');
    var Grandedrink = document.getElementById('Grandedrink');
    var bakery = document.getElementById('bakery');
    var lunch = document.getElementById('lunch');
    const coffeeData = foodItem.filter((item) => item.category == 'Coffee');
    const coldbrewData = foodItem.filter((item) => item.category == 'coldbrew');
    const frappuccinoData = foodItem.filter((item) => item.category == 'frappuccino');
    const GrandedrinkData = foodItem.filter((item) => item.category == 'Grandedrink');
    const bakeryData = foodItem.filter((item) => item.category == 'bakery');
    ...
    coffeeData.map(item => {
        ...
        caffee.appendChild(itemCard);
    })
    coldbrewData.map(item => {
        var itemCard = document.createElement('div');
        itemCard.setAttribute('id', 'item-card')
        var cardTop = document.createElement('div');
        cardTop.setAttribute('id', 'card-top');
        ...
        coldbrew.appendChild(itemCard)

    })

    frappuccinoData.map(item => {
        var itemCard = document.createElement('div');
        itemCard.setAttribute('id', 'item-card')
        var cardTop = document.createElement('div');
        cardTop.setAttribute('id', 'card-top');
        ...
        itemCard.appendChild(itemName);
        itemCard.appendChild(itemPrice);
        frappuccino.appendChild(itemCard)

    })

    GrandedrinkData.map(item => {
        var itemCard = document.createElement('div');
        itemCard.setAttribute('id', 'item-card')
        ...
        Grandedrink.appendChild(itemCard)
